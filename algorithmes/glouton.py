villes =[
    "Azores","Baghdad","Berlin","Bombay","Buenos Aires","Cairo","Capetown","Chicago",
    "Guam","Honolulu","Istanbul","Juneau","London","Manila","Melbourne","Mexico City",
    "Montreal","Moscow","New Orleans","New York","Panama City","Paris","Rio de Janeiro",
    "Rome","San Francisco","Santiago","Seattle","Shanghai","Sydney","Tokyo"
]
dist=[
